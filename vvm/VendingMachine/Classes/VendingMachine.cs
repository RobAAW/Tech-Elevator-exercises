...
namespace VendingMachine.Classes
{
    ...
    {
        //private IDAO dataAccessObject = new FileDAO();
        ...
        public VirtualVendingMachine()
        {
            ...
            dataAccessObject = new DBDAO("Server=.\\SQLEXPRESS;Database=VendingMachine;Trusted_Connection=True;");
            // load it up!
            string directory = Environment.CurrentDirectory;
            string fullPath = Path.Combine(directory, "vendingmachine.csv");
            inventory = dataAccessObject.LoadMachine(fullPath);
        ...
        public decimal FeedMoney(int dollars)
        {
            ...
            // Log it
            dataAccessObject.LogTransaction("FEED MONEY", (decimal)dollars, CurrentBalance);
        ...
        public VendingMachineItem Purchase(string slotID)
        {
            ...
            if (GetQuantityOfSlot(slotID) > 0)
            {
                ...
                if (_currentBalance >= GetCostOfSlot(slotID))
                {
                    ...
                    // log the purchase
                    dataAccessObject.LogTransaction(purchasedItem.itemName + " " + slotID, purchasedItem.price, _currentBalance);
        ...
        public ChangeDrawer ReturnChange()
        {
            ...
            dataAccessObject.LogTransaction("GIVE CHANGE", CurrentBalance, 0M);

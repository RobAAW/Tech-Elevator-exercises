 ...
 * @param {string[]} [listOfQuirks] the list of quirks
 */
...
function allDivisibleByThree(numbersToFilter) {
  ...
  for(let i = 0; i < numbersToFilter.length; i++)
  {
    ...
    {
      multiplesOfThree.push(numbersToFilter[i]);
    }
  }
...
function sumEmUp()
{
  return sumAllNumbersWithParameters([2,4,6,8,10],addNumber);
}
